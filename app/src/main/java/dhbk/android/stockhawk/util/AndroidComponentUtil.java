...
public class AndroidComponentUtil {
     ...
     *
     * @see <a href="http://www.grokkingandroid.com/enabling-and-disabling-broadcastreceivers/"></a>
     * @param context
    ...
    public static void toggleComponent(Context context, Class componentClass, boolean enable) {
        ...
        // do mặc định khi bật hay tắt thì ảnh hướng dấn app nên Android sẽ kill app ngay, ta ko muốn kill app nen ta declare là DONT_KILL_APP
